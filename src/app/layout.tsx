...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang="ru">
      <body>
        <div className="site-loader" role="status" aria-live="polite" aria-label='Загрузка сайта "В Ёлках"'>
          <div className="site-loader-card">
            <div className="site-loader-logo-shell">
              <img src="/logo/logo.webp" alt="" width="122" height="122" />
            </div>
            <strong className="site-loader-title">В Ёлках</strong>
            ...
            <small>Готовим лесное пространство</small>
          </div>
        </div>
        <script
