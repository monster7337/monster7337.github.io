...
import { ArrowLeft, ArrowRight, CalendarDays, Heart, LayoutGrid, PawPrint, Sparkles, X } from "lucide-react";
...
const speciesGroups: SpeciesGroup[] = [
  {
    ...
    coverImage: "/bg/ворчун.jpg",
    coverAlt: "Минипиги антикафе В Ёлках",
    stats: "8 минипигов",
  },
  {
    id: "squirrels",
...
const animals: AnimalProfile[] = [
  {
    ...
    kind: "Минипиг",
    image: "/bg/ворчун.jpg",
    imageAlt: "Минипиг Ворчун в антикафе В Ёлках",
  ...
  },
  {
    ...
    kind: "Минипиг",
    image: "/bg/чуня.jpg",
    imageAlt: "Минипиг Чуня в антикафе В Ёлках",
    ...
    facts: ["настоящая девчонка по характеру", "часто пачкает моську", "одна из самых запоминающихся минипигов"],
  },
  {
    slug: "tigra",
    name: "Тигра",
    ...
    kind: "Минипиг",
    image: "/bg/тигра.jpg",
    imageAlt: "Минипиг Тигра в антикафе В Ёлках",
  ...
  },
  {
    ...
    species: "minipigs",
    kind: "Минипиг",
    image: "/bg/мотамота.jpg",
    imageAlt: "Минипиг Мота Мота в антикафе В Ёлках",
  ...
  },
  {
    ...
    kind: "Минипиг",
    image: "/bg/персик.jpg",
    imageAlt: "Минипиг Персик в антикафе В Ёлках",
  ...
  },
  {
    ...
    kind: "Минипиг",
    image: "/bg/марти.jpg",
    imageAlt: "Минипиг Марти в антикафе В Ёлках",
  ...
  },
  {
    ...
    kind: "Минипиг",
    image: "/bg/пират.jpg",
    imageAlt: "Минипиг Пират в антикафе В Ёлках",
    badge: "Малыш-сплюшка",
  ...
  },
  {
    ...
    kind: "Минипиг",
    image: "/bg/пумба.jpg",
    imageAlt: "Минипиг Пумба в антикафе В Ёлках",
  ...
  },
  {
    ...
    facts: ["единственный бурундук в этой подборке", "очень ручная", "невероятно любопытная"],
  },
  {
    slug: "smok",
    name: "Смок",
...
export default function Animals({ onOpenBooking }: AnimalsProps) {
  ...
  return (
    <>
      <section id="animals" className="forest-section py-12 sm:py-14" style={{ backgroundImage: "url('/bg/grass1.png')" }}>
