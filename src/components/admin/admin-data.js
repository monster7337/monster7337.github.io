import { BOOKING_EXTRAS } from "@/lib/bookingCatalog";

export const ADMIN_APPOINTMENTS_KEY = "velkah-admin-appointments-v2";
export const ADMIN_SETTINGS_KEY = "velkah-admin-settings";
export const ADMIN_ACTIVITY_KEY = "velkah-admin-activity-v2";
export const ADMIN_GIFT_CERTIFICATES_KEY = "velkah-admin-gift-certificates-v2";
export const ADMIN_FINANCE_RECORDS_KEY = "velkah-admin-finance-records-v2";

const ADMIN_DATA_RESET_MARKER = "velkah-admin-data-reset-v2";
const LEGACY_ADMIN_DATA_KEYS = [
  "velkah-admin-auth",
  "velkah-admin-appointments",
  "velkah-admin-activity",
  "velkah-admin-gift-certificates",
...
const siteExtras = BOOKING_EXTRAS.map((item) => ({
  id: item.id,
  title: item.title,
  price: item.price,
...
const siteGiftCertificates = [
  {
    id: "gift-visit",
    title: "Подарочный сертификат на посещение",
    description: "Сертификат на визит для одного гостя или группы.",
    price: 1500
  },
  {
    id: "gift-standard",
    title: "Сертификат на стандартный визит",
    description: "Готовый подарок для пары или друзей.",
    price: 3000
  },
  {
    id: "gift-family",
    title: "Семейный сертификат",
    description: "Теплый подарок для семьи или небольшой компании.",
    price: 4200
  },
  {
    id: "gift-nominal",
    title: "Свободный номинал",
    description: "Если хочется оставить получателю выбор по дате и сумме.",
    price: 3000
  }
];
...
function getSafeLocalStorage() {
  ...
  try {
    const testKey = "__velkah_admin_storage_test__";
...
export function savePublicBooking(values) {
  ...
  const appointment = normalizeAppointment({
    ...
    source: "Сайт",
    prepaymentAmount: values.prepaymentAmount ?? 0,
