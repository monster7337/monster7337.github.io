...
export const BOOKING_TICKETS: BookingTicket[] = [
  ...
  },
  {
    ...
    location: BOOKING_CONTACTS.address,
    description:
      "Акция на посещение в будний день в 11:00 или 13:00 со скидкой 33%: один час общения с белками и минипигами + чай, кофе, сок, вода и сладости.",
    mobileDescription: "Будний визит на 11:00 или 13:00 по сниженной цене.",
    details: "Сниженная цена действует только по будням при посещении в 11:00 или 13:00. Для другого времени выбирайте стандартный, семейный или льготный билет.",
  ...
  },
  {
    ...
    details: "Семейная цена действует для трех и более гостей. Если гостей меньше, лучше выбрать стандартный или льготный билет.",
  ...
  },
  {
    ...
    location: BOOKING_CONTACTS.address,
    description:
      "Классический билет на 1 час в антикафе с белками и минипигами. Можно выбрать время: 15:00, 17:00 или 19:00.",
    mobileDescription: "Классический билет на 1 час в антикафе с белками и минипигами.",
    details: "Обычный билет без дополнительных условий: подходит для первого визита, пары, семьи и друзей.",
    note: "Время на выбор: 15:00, 17:00 и 19:00",
    button: "forest",
  },
];
