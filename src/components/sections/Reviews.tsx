...
const reviews = [
  ...
  },
  {
    platformId: "yandex",
    platform: "Яндекс",
    name: "Максим Осипенко",
    role: "отзыв на Яндекс Картах",
    date: "23.05.2026",
    rating: 5,
    title: "Волшебное пространство для детей и взрослых",
    text: "Волшебное пространство с белочками, сахарными поссумами, бабочками и кроликами. Очень приятная и комфортная атмосфера для досуга с детьми, да и взрослым тоже интересно пообщаться с животными. Белки контактны, сами идут на общение, любят забраться даже на голову и не отказываются от орешков и семечек. Особенно тронуло взаимодействие сотрудников со зверюшками: мило, чутко, заботливо, все рассказывают не просто по видам, а действительно по каждой особи. Также можно посидеть и попить чай или кофе со сладостями. Мы остались безмерно счастливы от проведенного времени.",
    mobileText: "Очень приятная и комфортная атмосфера для отдыха с детьми и взрослыми. Белки сами идут на общение, любят забираться даже на голову, а сотрудники очень чутко и заботливо подсказывают, как лучше взаимодействовать с каждым животным. После визита гости остались очень счастливы.",
  },
];
