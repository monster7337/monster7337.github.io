...
export const faqs = [
  ...
  { q: "Можно со своей едой?", a: "Напитки и сладости у нас есть, по остальному лучше уточнить при записи." },
  {
    ...
    a: "Самостоятельной отмены и возврата на сайте нет. Для отмены, переноса или запроса возврата необходимо позвонить администратору по номеру на сайте. Возврат оформляет владелец после проверки обращения в соответствии с договором оферты.",
  },
];
